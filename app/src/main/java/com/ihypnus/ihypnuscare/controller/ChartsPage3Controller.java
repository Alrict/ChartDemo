...
public class ChartsPage3Controller extends BaseController {
    ...
    public void updateUI(List<Double> tpInValues, List<Double> ahiValues) {
        ...
        //创建多条折线的图表
        mBarChartManager1.showBarChart(mXValues, mYValues1, "90%吸气压力(厘米水柱)", "90%吸气压力(厘米水柱)", false);
        mBarChartManager2.showBarChart(mXValues, mYValues2, "AHI(次/小时)", "AHI(次/小时)", false);
    }
}
