 ...
 */
public class AppRadioButton extends RadioButton implements LanguageChangableView{
    ...
    public AppRadioButton(Context paramContext, AttributeSet paramAttributeSet) {
        super(paramContext, paramAttributeSet);
        init(paramContext, paramAttributeSet);
    }

    public AppRadioButton(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
