package com.kye.smart.multi_image_selector_library.adapter;
...
//                                getInstance().displayImage("file://" + new File(f.cover.path).getPath(),holder.cover);

                        Picasso.with(mContext)
                                .load(new File(f.cover.path))
                                .placeholder(R.mipmap.mis_default_load)
...
//                com.nostra13.universalimageloader.core.ImageLoader.
//                        getInstance().displayImage("file://" + new File(data.cover.path).getPath(),cover);
